...
import numpy as np
from contracts import BatchStats
...
def calculate_batch_statistics(
    batch_size: int, latencies: List[float], engine_name: str = ""
) -> BatchStats:
    """
    ...
    Args:
        ...
        engine_name: Name of the engine that ran this benchmark
    ...
    Example:
        ...
        >>> stats = calculate_batch_statistics(batch_size=4, latencies=latencies, engine_name="pytorch_cpu")
